  ...
  return (
    <div className="relative flex h-screen w-full flex-col bg-black bg-[url('/technology/background-technology-desktop.jpg')] md:h-full">
      <div className="lg:mx-auto lg:max-w-screen-xl">
        <div className="mt-10 flex justify-center px-6 pt-20 font-barlow text-base tracking-[.25em] animate-in slide-in-from-top-1 duration-700 md:justify-start md:text-xl lg:pt-40 lg:text-2xl">
